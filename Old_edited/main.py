        ...
        for row in reader:
            ...
            <TALLYMESSAGE xmlns:UDF="TallyUDF">
                <VOUCHER VCHTYPE="{vch_type}" ACTION="Create">
                    ...
                    <PARTYLEDGERNAME>Karur Vyshya Bank</PARTYLEDGERNAME> <!-- Top ledger -->
<ALLLEDGERENTRIES.LIST>
    <LEDGERNAME>Temp1</LEDGERNAME> <!-- Counterparty (who paid you) -->
    <AMOUNT>{amount}</AMOUNT> <!-- Negative for Receipt -->
</ALLLEDGERENTRIES.LIST>

<ALLLEDGERENTRIES.LIST>
    <LEDGERNAME>Karur Vyshya Bank</LEDGERNAME> <!-- Account ledger -->
